...
class AIStyles:
    ...
    def setup_ai_styles(cls):
        ...
        style.configure('AIPanel.TFrame',
        ...
        style.configure('AI.Status.TLabel',
                       font=('TkDefaultFont', 9),
                       foreground=cls.COLORS['success'])
        
        # Стили для переключателей
        style.configure('AI.Toggle.TCheckbutton',
                       background=cls.COLORS['background'],
                       indicatoron=False,
                       padding=(20, 0),
                       font=('TkDefaultFont', 9))
