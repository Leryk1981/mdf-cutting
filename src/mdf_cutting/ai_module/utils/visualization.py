...
class CorrectionVisualizer:
    ...
    def visualize_cutting_map(
        ...
        logger.warning(
            "Визуализация недоступна. Установите matplotlib для полной функциональности."
        )
        return None
    ...
    def plot_training_history(
        self, history: List[Dict[str, Any]], save_path: Optional[str] = None
    ):
    ...
    def create_summary_report(
        ...
        with open(report_path, "w", encoding="utf-8") as f:
            ...
            f.write(
                f"Потенциал улучшения: {metrics.get('improvement_potential', 0):.3f}\n\n"
            )
