...
class LayoutValidator:
    ...
    def validate_corrections(self, original_layout: Dict, 
    ...
    def _check_technical_constraints(self, original_layout: Dict,
                                   corrections: Dict, 
                                   result: Dict):
    ...
    def _check_geometric_parameters(self, original_layout: Dict,
                                  corrections: Dict, 
                                  result: Dict):
    ...
    def _check_optimization_quality(self, original_layout: Dict,
                                  corrections: Dict, 
                                  result: Dict):
