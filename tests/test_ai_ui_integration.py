...
class TestImprovedAIControlPanel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Создание панели
        self.panel = ImprovedAIControlPanel(
            self.root, self.ai_service, self.app
        )
...
class TestDetailDialog(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.suggestion_data = {
            ...
            "confidence": 0.85,
            "expected_improvement": 0.12,
            "parameters": {"angle": 90, "priority": "high"},
        }
...
class TestImprovedFeedbackDialog(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dialog = ImprovedFeedbackDialog(
            self.root, self.feedback_collector
        )
    ...
    def test_dialog_creation(self):
        ...
        self.assertIsNotNone(self.dialog)
        self.assertEqual(
            self.dialog.feedback_collector, self.feedback_collector
        )
    ...
    def test_feedback_submission_error(self, mock_showerror):
        ...
        self.feedback_collector.collect_feedback.side_effect = Exception(
            "Test error"
        )
