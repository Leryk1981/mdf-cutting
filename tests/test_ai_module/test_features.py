...
class TestGeometryFeatureExtractor:
    ...
    @patch('src.mdf_cutting.ai_module.features.geometry.SHAPELY_AVAILABLE', False)
...
class TestOptimizationFeatureExtractor:
    ...
    def test_extract_features_success(self):
        ...
        features = self.extractor.extract_features(self.test_dxf_data, self.test_order_data)
    ...
    def test_extract_material_features(self):
        ...
        features = self.extractor._extract_material_features(self.test_dxf_data, self.test_order_data)
    ...
    def test_extract_efficiency_features(self):
        ...
        features = self.extractor._extract_efficiency_features(self.test_dxf_data)
...
class TestMaterialFeatureExtractor:
    ...
    def test_extract_features_success(self):
        ...
        features = self.extractor.extract_features(self.test_material_data, self.test_order_data)
    ...
    def test_extract_basic_features(self):
        ...
        features = self.extractor._extract_basic_features(self.test_material_data, self.test_order_data)
    ...
    def test_extract_technical_features(self):
        ...
        features = self.extractor._extract_technical_features(self.test_material_data, self.test_order_data)
    ...
    def test_extract_processing_features(self):
        ...
        features = self.extractor._extract_processing_features(self.test_material_data, self.test_order_data)
    ...
    def test_is_standard_thickness(self):
        ...
        assert self.extractor._is_standard_thickness(16.0, "MDF") == True
        assert self.extractor._is_standard_thickness(18.0, "MDF") == True
        assert self.extractor._is_standard_thickness(25.0, "MDF") == True
        assert self.extractor._is_standard_thickness(7.5, "MDF") == False  # Нестандартная толщина 